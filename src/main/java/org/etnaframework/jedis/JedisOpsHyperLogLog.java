...
/**
 * redis基数统计HyperLogLog操作集合
 *
 * Created by yuanhaoliang on 2017-08-21.
 */
public class JedisOpsHyperLogLog extends JedisOps {

    protected JedisOpsHyperLogLog(JedisTemplate jedisTemplate) {
        super(jedisTemplate);
    }
     ...
     *
     * @see <a href="http://redisdoc.com/hyperloglog/pfadd.html">http://redisdoc.com/hyperloglog/pfadd.html</a>
     */
     ...
     * >= 2.8.9
     * 时间复杂度：
     * 当命令作用于单个 HyperLogLog 时， 复杂度为 O(1) ， 并且具有非常低的平均常数时间。 当命令作用于 N 个 HyperLogLog 时， 复杂度为 O(N) ， 常数时间也比处理单个 HyperLogLog
     * 时要大得多。
     * 返回值：
     * 整数回复： 给定 HyperLogLog 包含的唯一元素的近似数量。
     * </pre>
     *
     * @see <a href="http://redisdoc.com/hyperloglog/pfcount.html">http://redisdoc.com/hyperloglog/pfcount.html</a>
     */
     ...
     * </pre>
     *
     * @see <a href="http://redisdoc.com/hyperloglog/pfmerge.html">http://redisdoc.com/hyperloglog/pfmerge.html</a>
     */
