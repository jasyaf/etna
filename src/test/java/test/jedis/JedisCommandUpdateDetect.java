...
/**
 * 用于升级jedis库时检测Jedis命令是否有更新。如果有，需要同步更新JedisTemplate
 *
 * Created by yuanhaoliang on 2017-08-21.
 */
class JedisCommandUpdateDetect implements JedisCommands, MultiKeyCommands {

    private JedisCommandUpdateDetect() {
    }
